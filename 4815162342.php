...
<body class="theme">
    ...
    <div class="flex flex-col h-full page justify-center sm:items-stretch" style="display: none;">
        
    <div class="flex flex-col py-4 gap-4 justify-center items-center" id="cards-game">
        <ul>
            <li>Win streak: <span id="winStreak"></span></li>
            <li>Longest Streak: <span id="longest"></span></li>
            <li>Total wins: <span id="totalW"></span></li>
            <li>Total losses: <span id="totalL"></span></li>
        </ul>

        <button class="default px-4 py-2 rounded-full" type="button" id="retrieve">Retrieve your stats</button>
    </div>
...
<script type="module" src="<?= getAssetPath('statsMod.js'); ?>"></script>
