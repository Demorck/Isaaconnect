...
<body class="theme">
    ...
    <div class="flex self-center flex-col gap-5">

        <audio id="audio" src="/assets/sfx/19 Ambush.mp3"></audio>
        <button class="bg-red-500 p-4 rounded" id="a">BOUTON</button>
        <input type="range" name="slider" id="slider" min="0" max="1000">
        <div class="flex" style="height: 20px; width:1000px">
            <div id="rempli" style="background: red;"></div>
            <div class="flex-1" id="vide" style="background: white;"></div>
        </div>

        <div class="flex flex-row gap-2">
            <button class="flex-1 bg-green-400 p-4 rounded" type="button" id="b0">0</button>
            <button class="flex-1 bg-green-400 p-4 rounded" type="button" id="b1">1</button>
            <button class="flex-1 bg-green-400 p-4 rounded" type="button" id="b2">2</button>
            <button class="flex-1 bg-green-400 p-4 rounded" type="button" id="b3">3</button>
            <button class="flex-1 bg-green-400 p-4 rounded" type="button" id="b4">4</button>
            <button class="flex-1 bg-green-400 p-4 rounded" type="button" id="b5">5</button>
        </div>
...
<script type="module" src="/dist/Heardle/Heardle.js"></script>
