...
<body class="theme">
    ...
    <div class="flex flex-col h-full page justify-center sm:items-stretch" style="display: none;">
        ...
        <div class="w-full flex justify-center">
            <div class="flex flex-col justify-center items-center w-1/2" id="cards-game">
                <h1 class="font-bold text-lg">Informations</h1>
...
<script type="module" src="<?= getAssetPath('infos.js'); ?>"></script>
