    ...
    <div class="flex flex-col h-full page  sm:items-stretch" style="display: none;">
        ...
        <?php 
            if (isset($_GET['options'])) {
                include 'include/template/maingame.php';
            } else {
                include 'include/template/options.php';
            } ?>
...
<?php 
    if (isset($_GET['options'])) {
        echo '<script type="module" src="/dist/MainGame/RandomGame.js"></script>';
    } else {
        echo '<script type="module" src="/dist/MainGame/RandomGameOptions.js"></script>';
    } 
?>
